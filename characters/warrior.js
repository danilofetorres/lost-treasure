...
class Warrior extends Enemy {
  ...
  constructor(id, scene, spawn, texture, frame, physics, max_health, speed, height, width) {
    ...
    this.hitboxes = [
      { hitbox: scene.add.circle(this.x, this.y, 15), can_hit: true, frames: [4, 10], m1: 2, m2: 1.05 },
      { hitbox: scene.add.rectangle(this.x + 20, this.y + this.height/5, 30, 30), can_hit: true, frames: [19, 29], m1: 2, m2: 1.05 },
    ]
