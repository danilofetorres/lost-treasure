...
//   smoothedControls;
  ...
  preload() {
    ...
    this.load.atlas("player", "../assets/character/player/idle/player_idle/player_idle.png", "../assets/character/player/idle/player_idle/player_idle.json");
    this.load.json("sprites", "sprites.json");
  ...
  create(data) {
    ...
    const player = this.matter.add.sprite(0, 0, "player", 2, { shape: spritePhysics.player });
